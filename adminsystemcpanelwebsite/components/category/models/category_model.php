...
class category_model extends CI_Model{
    ...
    function find_by_num($sections_id,$lang){
    ...
    function find_by_all($num,$offset,$sections_id = 0, $lang, $field, $order){
        if($field != '' && $order != ''){
        ...
        $this->db->where('lang',$lang);
        return $this->db->get('category',$num,$offset)->result();
    }
      ...
      function create_menu(){
            ...
            foreach($listcat_cap1 as $cap1):
                ...
                $listcat_cap2 = $this->vdb->find_by_list('shop_cat',array('parentid'=>$cap1->catid,'published'),array('ordering'=>'asc'));
                ...
                if($total_cap2 > 0){
                    ...
                    foreach($listcat_cap2 as $cap2):
                        ...
                        $listcat_cap3 = $this->vdb->find_by_list('shop_cat',array('parentid'=>$cap2->catid,'published'),array('ordering'=>'asc'));
            ...
            $str .= "\n";
            $str .= "\n";
            $str .= "\n\n/* End of file config_menu fyi.vn*/\n/* Location: .site/config/site/config_menu.php */";        
            write_file(ROOT.'site/config/site/config_menu.php', $str);
      }
