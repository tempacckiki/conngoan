...
<form accept-charset="utf-8" method="post" action="<?php echo base_url()?>quangcao/banner_news/banner2">
	<table class="form">
	    <tr>
	        ...
	        <td>
				...
				<?php if(isset($aBannerAds)) { ?>
					<div class="upload-img" id="imgBody">
						<?php
						$img	= base_url_site().'alobuy0862779988/bannerads/banner2/full_images/' . $aBannerAds->images;
						?>
...
$(function(){
	$('#swfupload-control1').swfupload({
		upload_url: "<?php echo site_url('quangcao/banner_news/uploader_banner2');?>",
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var imgPath = '<?=base_url_site();?>alobuy0862779988/bannerads/banner2/full_images/'+serverData;	
