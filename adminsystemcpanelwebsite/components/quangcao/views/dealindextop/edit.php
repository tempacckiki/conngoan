    ...
    <tr>
        ...
        <td>
			...
			<div class="upload-img" id="imgBody">
				<?php
				$img	= (!empty($rs->images))? base_url_site().'alobuy0862779988/adv/dealindextop/full_images/'.$rs->images:base_url_site().'technogory/templates/default/images/no_image.gif';
				?>
