    ...
    <tr>
        ...
        <td>
			...
			<div class="upload-img" id="imgBody">
				<?php
				$img	= (!empty($rs->images))? base_url_site().'alobuy0862779988/adv/dealindex/full_images/'.$rs->images:base_url_site().'technogory/templates/default/images/no_image.gif';
				?>
...
$(function(){
	$('#swfupload-control').swfupload({
		upload_url: "<?php echo site_url('quangcao/dealindex/uploader');?>",
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var imgPath = '<?=base_url_site();?>alobuy0862779988/adv/dealindex/full_images/'+serverData;	
