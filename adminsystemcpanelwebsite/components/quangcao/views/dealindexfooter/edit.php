...
<table class="form">
    ...
    <tr>
        ...
        <td>
          	<textarea rows="7" cols="60" name="decription"><?=$rs->decription;?></textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="w300" name="price_old" id="price_old" value="<?=number_format($rs->price_old, 0, '.','.');?>">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
			...
			<div class="upload-img" id="imgBody">
				<?php
				$img	= (!empty($rs->images))? base_url_site().'alobuy0862779988/adv/dealindexfooter/full_images/'.$rs->images:base_url_site().'technogory/templates/default/images/no_image.gif';
				?>
...
$(function(){
	$('#swfupload-control').swfupload({
		upload_url: "<?php echo site_url('quangcao/dealindexfooter/uploader');?>",
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var imgPath = '<?=base_url_site();?>alobuy0862779988/adv/dealindexfooter/full_images/'+serverData;	
