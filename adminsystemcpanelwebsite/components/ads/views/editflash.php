    ...
    <tr>
        ...
        <td>
			<div id="swfupload-control">
				<p>Kiểu hình uploads:(.swf), dung lượng tối đa: 1MB  - <strong>KT: W:1000px - H: auto</strong></p>
			...
			<div class="upload-img" id="imgBody">
				...
				?>			
				<img src="<?php echo $fileF;?>" width="90" height="90">	
				<input type="hidden" value="<?=$fileFlash;?>" name="view-banner"> 
			</div>
		</td>
    </tr>
    <tr>
    	 ...
    	 <td>
    	 	<input type="text" value="<?php echo $linkBanner;?>" name="link-banner" class="w300">
    	 </td>
    </tr>
</table>
<?=form_close();?>
...
$(function(){
	$('#swfupload-control').swfupload({
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			$('#imgBody').html('<img src="'+imgPath+'" width="90" height="90"><br><input type="hidden" name="view-banner" value="'+serverData+'">');
