...
<table class="form">
    <tr>
        ...
        <td><input type="text" name="ads[name]" value="" class="w500"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="ads[type]" value="R" checked="checked"> Mua nhiều
        	<input type="radio" name="ads[type]" value="R1"> Hot nhất
        	<input type="radio" name="ads[type]" value="F" > Footer
        </td>
    </tr>
     <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="ads[url]" value="http://"></td>
    </tr>
     <tr>
