            ...
            <td valign="top">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="hot" value="1" <?=($rs->hot == 1)?'checked="checked"':''?>> Nổi bật
                            <input type="checkbox" name="is_thumb" value="1" <?=($rs->is_thumb == 1)?'checked="checked"':''?>> Hiện thumb
                        </td>
                    </tr>
                    <tr>
				        ...
				        <td>
							...
							<div class="upload-img" id="imgBody">
								...
								$img	= (!empty($rs->images))? base_url_site().'alobuy0862779988/news/full_images/'.$rs->images:base_url_site().'technogory/templates/default/images/no_image.gif';
								$nameImg	= end(explode('/', $rs->images));
								?>
								<img src="<?=$img?>" width="85"><br>
								<input type="hidden" value="<?=$nameImg;?>" name="img"> 
							</div>
						</td>
				    </tr>
                    <tr>
