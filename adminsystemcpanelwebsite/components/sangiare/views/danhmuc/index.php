<?php echo form_open('sangiare/danhmuc/dels',  array('id' => 'admindata'));
...
<table class="admindata">
    <thead>
        ...
        <tr>
            ...
            <th class="id"><?php echo vnit_order('sangiare/danhmuc/listcategory/0/cat_id/desc'.$sections_url,'ID')?></th>
            <th><?php echo vnit_order('sangiare/danhmuc/listcategory/0/cat_title/desc'.$sections_url,'Tiêu đề')?></th>
            <th style="width: 30px;"><?php echo vnit_order('sangiare/danhmuc/listcategory/0/ordering/desc'.$sections_url,'Sắp xếp')?> <?php echo action_order()?></th>
    ...
    <tr class="row<?=$k?>">
        ...
        <td align="center">
            <?=icon_edit('sangiare/danhmuc/edit/'.$rs->cat_id)?>
