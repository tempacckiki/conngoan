...
<div class="gray">
        <div id="thongtin" class="content" style="display: block;">
            <table class="form">
                <tr>
                    ...
                    <td><input type="text" name="date[product_name]" value="<?=$pro->productname?>" class="w400"></td>
                </tr>
                <tr>
                    <td class="label">Tiêu đề - vi</td>
                    <td><input type="text" name="data[cheap_title]" value="<?=set_value('data[cheap_title]')?>" class="w400"></td>
                </tr>
                <tr>
                    <td class="label">Tiêu đề - en</td>
                    <td><input type="text" name="data_en[cheap_title]" value="<?=set_value('data_en[cheap_title]')?>" class="w400"></td>
                </tr>

                <tr>
                    <td class="label">Giá thị trường</td>
                    <td><input type="text" name="data[cheap_price_old]" id="cheap_price_old" value="<?=number_format($pro->giathitruong_miennam,0,'.','.')?>"></td>
                </tr> 
                <tr>
                    <td class="label">Giá mua rẻ</td>
                    <td><input type="text" name="data[cheap_price]" id="cheap_price" value="<?=set_value('data[cheap_price]')?>"></td>
                </tr>
                <tr>
                    <td class="label">Tiết kiệm</td>
                    <td><input type="text" name="data[cheap_saving]" id="cheap_saving" value="<?=set_value('data[cheap_saving]')?>"> = <input type="text" name="data[cheap_per]" value="<?=set_value('data[cheap_per]')?>" class="w30" id="cheap_per">%</td>
                </tr>
                <tr>
                    <td class="label">Số lượng cơ hội mua rẻ</td>
                    <td><input type="text" name="data[cheap_qty]" value="<?=set_value('data[cheap_qty]')?>"></td>
                </tr>
                <tr>
                    <td class="label">Số lương/ Lần mua</td>
                    <td><input type="text" name="data[cheap_buy_limit]" value="<?=set_value('data[cheap_buy_limit]')?>"></td>
                </tr>
                <tr>
        ...
        <div id="mieuta" class="content">
            <p>Tiếng Việt</p>
            <textarea id="full" name="data[cheap_des]"></textarea>
            <p>Tiếng Anh</p>
            <textarea id="en_full" name="data_en[cheap_des]"></textarea>
        </div>  
        <div id="chucnang" class="content">
            <p>Tiếng Việt</p>
            <textarea id="editor_chucnang" name="data[cheap_properties]"></textarea>
            <p>Tiếng Anh</p>
            <textarea id="en_editor_chucnang" name="data_en[cheap_properties]"></textarea>
        </div> 
        <div id="noibat" class="content">
            <p>Tiếng việt</p>
            <textarea id="editor_noibat" name="data[cheap_highlights]"></textarea>
            <p>Tiếng anh</p>
            <textarea id="en_editor_noibat" name="data_en[cheap_highlights]"></textarea>
        </div> 
        <!-- Thuoc tinh-->
        <div id="dieukien" class="content">
            <p>Tiếng việt</p>
            <textarea id="editor_dieukien" name="data[cheap_condi]"></textarea>
            <p>Tiếng Anh</p>
            <textarea id="en_editor_dieukien" name="data_en[cheap_condi]"></textarea>
        </div>
</div>
<?=form_close()?>
<script type="text/javascript">
