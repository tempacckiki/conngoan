...
class tintuc extends CI_Controller{
    ...
    function index(){
        redirect('daugia/tintuc/listcontent');
    }
    
    function listcontent(){
        $data['title'] = 'Quản lý bài viết';
        $data['add'] = 'daugia/tintuc/add';
        $data['delete'] = true;
        ...
        $config['base_url'] = base_url().'daugia/tintuc/listcontent/';  
    ...
    function add(){
        ...
        $data['save'] = true;
        $data['apply'] = true;
        $data['cancel'] = 'daugia/tintuc/listcontent';        
        ...
        if($this->form_validation->run() === FALSE){
            ...
            if($id = $this->vdb->update('content',$con)){
                ...
                if($option == 'save'){
                   $url = 'daugia/tintuc/listcontent';
                }else{
                    $url = 'daugia/tintuc/edit/'.$id;
                }
                redirect($url);
            }
        }
    ...
    function dels(){
        ...
        redirect('daugia/tintuc/listcontent/'.$page);
    }          
}
