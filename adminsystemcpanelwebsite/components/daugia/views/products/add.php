...
<script type="text/javascript" >
    $(function(){
        ...
        new AjaxUpload(btnUpload, {
            action: '<?php echo base_url();?>daugia/shop/uploader_templ/',
            name: 'uploadfile',
        ...
        <div id="thongtin" class="content" style="display: block;">
            <table class="form">
                ...
                <tr>
                    ...
                    <td><input type="text" id="price" name="sp[price]" value=""></td>
                </tr>
        ...
        <div id="hinhanh" class="content">
            <table class="form">
                <tr>
                    ...
                    <td>
                        <div id="main_img">
                            <img src="<?=base_url_site()?>technogory/templates/default/images/no_image.gif" width="90" alt="">
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php foreach($listimg as $img):?>
                            <li class="success">
                                <div align="center">
                                    <img width="85" height="85" src="<?=base_url_site()?>alobuy0862779988/shop/product/200/<?=$img->imagepath?>" onclick="chosen(<?=$img->imageid?>)">
...
function chosen_tmpl(img){
    if(img){
        $('#productimg').val(img);
        $('#main_img').html('<img src="' + base_url_site +'alobuy0862779988/daugia/full_images/' + img + '" width="80" height="80" />');
    }
    else{
        return false;
    }
