...
var imageFilesPath = base_url + "templates/images/date_picker/";
...
function RenderCssCal(bNewCal)
{
    ...
    if (!winCal)
    {
        ...
        cssStr = ".calTD {font-family: verdana; font-size: 12px; text-align: center; border:0;padding:4px }\n";
        cssStr += ".calR {font-family: verdana; font-size: 12px; text-align: center; font-weight: bold;}\n";
        cssStr += "#calBorder {border-radius:5px 5px 5px;}";
