...
function read_img($file_name,$foler = 'bannertop'){
    $ext = end(explode('.',$file_name));
    $file = base_url_site().'alobuy0862779988/adv/'.$foler.'/'.$file_name;
    if($ext == 'swf' || $ext == 'SWF'){
        return '<object width="150" height="100" border="0" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"><param value="'.$file.'" name="movie"><param value="always" name="AllowScriptAccess"><param value="High" name="quality"><param value="transparent" name="wmode"><embed width="150" height="100" allowscriptaccess="always" wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" src="'.$file.'"></object>';
    }else{
        return '<img src="'.$file.'" width="90">';
    }
}
