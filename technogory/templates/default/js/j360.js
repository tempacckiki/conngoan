    ...
    $.fn.j360 = function(options) {
        ...
        return this.each(function() {
            ...
            $obj.css({
             ...
             //$obj.prepend('<img src="'+site_url+'site/templates/fyi/images/loading.gif" class="loader" style="margin-top:' + ($obj.height()/2 - 15) + 'px" />');

            $overlay = $obj.clone(true);
            $overlay.html('<img src="'+site_url+'site/templates/fyi/images/loading.gif" class="loader" style="margin-top:' + ($obj.height()/2 - 15) + 'px" />');
