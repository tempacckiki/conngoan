...
***************************/
  class photo extends CI_Controller{
      ...
      function __construct(){
          ...
          $css_array = array(
                array(base_url().'site/components/photo/views/esset/photo.css')
          ); 
          $js_array = array(
                array(base_url().'site/components/photo/views/esset/photo.js')
          );           
      ...
      function index(){
          $data['title'] = 'Hình ảnh hoạt động';
          $data['des'] = 'Hình ảnh hoạt động';
          $this->link[0] = 'Hình ảnh hoạt động';
          $data['list'] = $this->photo->get_list_cat();
