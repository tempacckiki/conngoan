...
class CI_nganluong 
{
    ...
    // Mã merchante site 
    private $merchant_site_code = '23590';    // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site

    // Mật khẩu bảo mật
    private $secure_pass= 'nganluongsusu393939'; // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site
