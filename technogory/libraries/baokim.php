...
class CI_baokim 
{
    ...
    // Mã merchante site 
    private $merchant_id = '1042';    // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

    // Mật khẩu bảo mật
    private $secure_pass = 'ee5325629774a641'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
