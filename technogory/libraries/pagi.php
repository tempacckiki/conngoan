          ...
          //$id_blog = $this->input->post('id_blog');
            ...
            */
            ...
            {    
                ...
                //previous button
                if ($page > 1){ 
                    $pagination.= "<a id=\"page_x\" href=\"javascript:;\" onclick=\"$gopage($page-1)\">&lt;</a>";
                }else{
                    $pagination.= "<a id=\"page_x\" href=\"javascript:;\">&lt;</a>";    
                }
                ...
                {    
                    for ($counter = 1; $counter <= $lastpage; $counter++)
                    {
                        if ($counter == $page)
                            ...
                            $pagination.= "<a id=\"page_x\" href=\"javascript:; \" onclick=\"$gopage($counter)\">$counter</a>";                    
                    }
                }
                elseif($lastpage > 4 + ($adjacents * 2))    //enough pages to hide some
                {
                    ...
                    if($page < 1 + ($adjacents * 2))        
                    {
                        ...
                        $pagination.= "...";
                        $pagination.= "<a id=\"page_x\" href=\"javascript:; \" onclick=\"$gopage($lpm1)\">$lpm1</a>";
                        $pagination.= "<a id=\"page_x\" href=\"javascript:; \" onclick=\"$gopage($lastpage)\">$lastpage</a>";        
                    }
                    //in middle; hide some front and some back
                    elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
                    {
                        $pagination.= "<a id=\"page_x\" href=\"javascript:; \" onclick=\"$gopage(1)\">1</a>";
                        $pagination.= "<a id=\"page_x\" href=\"javascript:;\" onclick=\"$gopage(2)\">2</a>";
                        $pagination.= "...";
                        for ($counter = $page - $adjacents; $counter <= $page + $adjacents; $counter++)
                        {
                            if ($counter == $page)
