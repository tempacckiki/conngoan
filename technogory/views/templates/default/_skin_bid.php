...
<html>
<head>
   <title><?=$title;?> | ALOBUY Việt Nam - Mua hàng trực tuyến, Giao hàng tận nhà, Hotline (08) 62 77 99 88</title>
    ...
    <?php echo $this->load->view('templates/default/meta/meta_bid')?>
</head>
<body id="bd">
 ...
 <div id="main-container"> <!-- #wapper -->
    ...
    <div class="bg-title-main">    
			<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="<?=base_url()?>" itemprop="url" class="no-bg"><span itemprop="title">Trang chủ</span></a></div>
		     <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="<?=site_url('dau-gia')?>" itemprop="url"><span itemprop="title">Đấu giá</span></a></div>
		    <?php 
		    if(!empty($catinfo)){
		    ?>
